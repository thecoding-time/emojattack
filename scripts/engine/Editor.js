...
Editor.create = function(){
	...
	if(UI.options.edit==UI.ADVANCED){
		...
		var exportLabel = Editor.createLabel(
			...
			"<a href='https://thecoding-time.github.io/forest/' target='_blank'>[How To Do That]</a> "+
		...
		var creditsLabel = Editor.createLabel(`
			Made by <a href='https://thecoding-time.github.io/forest/' target='_blank'>Shaan Jain</a>,
			with the 💖 of their supporters
			p.s: <a href='https://thecoding-time.github.io/forest/' target='_blank'>open source!</a>
		`);
